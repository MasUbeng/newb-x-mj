...
#define NL_GAMMA 1.87                  // 0.3 low ~ 2.0 high
#define NL_EXPOSURE 0.9              // [toggle] 0.5 dark ~ 3.0 bright
#define NL_SATURATION 1.46            // [toggle] 0.0 grayscale ~ 4.0 super saturated
...
/* Terrain lighting */
#define NL_SUN_INTENSITY 1.93   // 0.5 weak ~ 5.0 bright
...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.00, 0.30, 0.00) //vec3(1.00, 0.40, 0.00) 
#define NL_UNDERWATER_TORCH_COL vec3(1.0,0.52,0.18)
#define NL_NETHER_TORCH_COL     vec3(1.00, 0.40, 0.00)
...
#define NL_DAY_ZENITH_COL    vec3(0.19, 0.42, 1.0)
#define NL_DAY_HORIZON_COL   vec3(0.59, 0.71, 1.0)
...
#define NL_DAWN_HORIZON_COL  vec3(0.8, 0.38, 0.0) //vec3(0.80, 0.55, 0.00)
#define NL_DAWN_EDGE_COL     vec3(0.80, 0.38, 0.00)
...
#define NL_CLOUD2_SCALE vec2(0.016, 0.022) // 0.003 large ~ 0.3 tiny
#define NL_CLOUD2_SHAPE 0.7     // 0.0 round ~ 1.0 box vec2(horizontal shape, vertical shape)
...
#define NL_CLOUD2_THICKNESS 3.      // 0.5 slim ~ 5.0 fat
...
#define NL_CLOUD2_DENSITY 400.0       // 1.0 blurry ~ 100.0 sharp
...
#define NL_CLOUDS_BRIGHTNESS 1.9
#define NL_CLOUDS_SHADOW_INTENSITY 0.8
